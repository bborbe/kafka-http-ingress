...
func readHttpRequest(r io.Reader) (*HttpRequest, error) {
	var str = &HttpRequest{}
	var err error
	str.Header, err = readMapArrayString(r)
	if err != nil {
		return nil, err
	}
	str.Body, err = readBytes(r)
	if err != nil {
		return nil, err
	}
...
func readMapArrayString(r io.Reader) (map[string][]string, error) {
...
func writeHttpRequest(r *HttpRequest, w io.Writer) error {
	var err error
	err = writeMapArrayString(r.Header, w)
	if err != nil {
		return err
	}
	err = writeBytes(r.Body, w)
	if err != nil {
		return err
	}
